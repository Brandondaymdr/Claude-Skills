...
All requests require: `Authorization: Bearer YOUR_API_TOKEN` and `Content-Type: application/json`

Token type must be **Admin V2** (created at Developers → Tokens in the Circle dashboard).
...
22. [Live Rooms](#live-rooms)
23. [Member Tags](#member-tags)
24. [Paywall Groups](#paywall-groups)
25. [Posts](#posts)
26. [Profile Fields](#profile-fields)
27. [Space Groups](#space-groups)
28. [Space Group Members](#space-group-members)
29. [Space Members](#space-members)
30. [Spaces](#spaces)
31. [AI Summaries](#ai-summaries)
32. [Tagged Members](#tagged-members)
33. [Topics](#topics)
...
Parameters for List: `post_id` (required), `page`, `per_page`, `status`
...
| PUT | `/community_members/{id}/delete_member` | Permanently delete member (hard delete) |
...
Returns members ranked by engagement points.
...
Manage Circle's built-in live streaming rooms.

| Method | Endpoint | Description |
|--------|----------|-------------|
| GET | `/live_rooms` | List Live Rooms |
| GET | `/live_rooms/{id}` | Show Live Room |
| GET | `/live_rooms/{id}/transcript` | Get Live Room Transcript |
